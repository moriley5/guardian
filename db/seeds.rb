...
memory = guardian.memories.create!(audio_recording: "audio1", description: "Grandpa reading Christmas story", date: DateTime.new(1996,12,25), audio: File.new("#{Rails.root}/app/assets/audio_recordings/ChristmasEve.m4a"))
